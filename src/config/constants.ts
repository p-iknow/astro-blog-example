...
export const constants = {
  ...
  uses: {
    environment: [
      ...
      {
        name: "Gnome",
        description: "Desktop environment - Wayland",
        link: "https://www.gnome.org",
      },
      {
        name: "JetBrains",
        description: "Font with ligatures support",
      ...
      {
        name: "Raycast",
        description: "Better Spotlight - Productivity",
        link: "https://www.raycast.com",
      },
      {
        name: "Tmux",
        description: "Terminal sessions management",
    ...
    cli: [
      ...
      {
        name: "Slides",
        description: "Terminal-based presentation",
        link: "https://github.com/maaslalani/slides",
      },
      {
        name: "Stow",
      ...
      {
        name: "Vifm",
        description: "Vim-based file manager",
        link: "https://vifm.info",
      },
      {
        name: "Volta",
        description: "JavaScript tool manager",
        link: "https://volta.sh",
      },
    ],
  },
